...
In [Part 1](/blog/how-i-code-from-the-gym), I wrote about running OpenCode Web on my Ubuntu desktop and using it from my phone over Tailscale. That setup works great, and I still use it. But it has one limitation I called out at the end of that post:
...
![Phone connecting to desktop via SSH and tmux](/images/gym-coding-part2-hero.png)
